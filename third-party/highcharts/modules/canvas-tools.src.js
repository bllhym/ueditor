    ...
    function build() {
        ...
        svg.Element.svg = function (node) {
            ...
            this.setContext = function (ctx) {
                ...
                if (typeof (this.root) == 'undefined' && this.attribute('width').hasValue() && this.attribute('height')
                                                                                                   .hasValue()) {
        ...
        svg.Element.marker = function (node) {
            ...
            this.render = function (ctx, point, angle) {
                ...
                if (this.attribute('markerUnits')
                        .valueOrDefault('strokeWidth') == 'strokeWidth') {
                ...
                tempSvg.attributes['stroke'] = new svg.Property('stroke', this.attribute('stroke')
                                                                              .valueOrDefault('none'));
                tempSvg.children = this.children;
                tempSvg.render(ctx);
                ctx.restore();
        ...
        svg.Element.text = function (node) {
            ...
            this.setContext = function (ctx) {
                this.baseSetContext(ctx);
                if (this.style('dominant-baseline')
                        .hasValue()) {
                    ctx.textBaseline = this.style('dominant-baseline').value;
                }
                if (this.style('alignment-baseline')
                        .hasValue()) {
            ...
            var draw = function () {
                ...
                if (svg.opts != null && svg.opts['scaleWidth'] != null && svg.opts['scaleHeight'] != null) {
                    ...
                    if (e.attribute('width').hasValue()) {
                        xRatio = e.attribute('width')
                                  .Length
                                  .toPixels('x') / svg.opts['scaleWidth'];
                    }
                    if (e.attribute('height').hasValue()) {
                        yRatio = e.attribute('height')
                                  .Length
                                  .toPixels('y') / svg.opts['scaleHeight'];
                    }
