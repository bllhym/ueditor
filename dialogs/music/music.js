...
(function(){
        ...
        (function(){
            ...
            if(img && img.className){
                ...
                if(hasFakedClass || hasUploadClass) {
                    $G("musicUrl").value = url = img.getAttribute("_url")||img.getAttribute("url");
        ...
        dialog.onok = function(){
            ...
            switch(currentTab){
                ...
                case "upload":
                    ...
                    break;
                case 'online':
                    list = onlineMusic.getInsertList();
                    break;
            }
        };
    ...
    function createPreviewMusic(url){
        ...
        $G("preview").innerHTML = '<div class="previewMsg"><span>' + lang.urlError + '</span></div>' +
            '<div class="previewMusic"><audio controls preload="meta" ' +
            ' src="' + conUrl + '"' +
            ' width="' + 420 + '"' +
            ' >' +
            '</audio></div>';
    ...
    OnlineMusic.prototype = {
        ...
        pushData: function (list) {
            ...
            for (i = 0; i < list.length; i++) {
                if(list[i] && list[i].url) {
                    ...
                    title.innerHTML=(editor.getOpt('allowFileDel')?'<span class="del" data-id="'+list[i].id+'">删除</span>':'')+list[i].title;
        ...
        getInsertList: function () {
            ...
            editor.execCommand('insertmusic',list);
            return list;
        },
