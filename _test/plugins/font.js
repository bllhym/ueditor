    ...
    setTimeout(function () {
        ...
        if (ua.browser.ie && ua.browser.ie < 9) {
            range.setStart(editor.body.firstChild.firstChild.firstChild.firstChild, 0)
                 .setEnd(editor.body.firstChild.firstChild.lastChild.firstChild, 6)
                 .select();
        } else {
...
test('trace 3096：单元格中改变字号', function () {
    ...
    setTimeout(function () {
        range.setStart(editor.body.firstChild.firstChild.firstChild.firstChild.firstChild, 0)
             .setEnd(editor.body.firstChild.firstChild.firstChild.firstChild.firstChild, 3)
             .select();
