    ...
    editor.ready(function () {
        ...
        setTimeout(function () {
            ...
            setTimeout(function () {
                ...
                editor.setContent(innerHTML);
                if (ua.browser.ie > 8) {
                    ua.checkSameHtml(editor.getContent()
                                           .toLowerCase(), '<p><span style="color: rgb(196, 189, 151);" ><strong>xx</strong><em>em</em></span></p>', "span style不空，套空的em和不空的em");
                } else {
                    ua.checkSameHtml(editor.getContent()
                                           .toLowerCase(), '<p><span style="color:#c4bd97" ><strong>xx</strong><em>em</em></span></p>', "span style不空，套空的em和不空的em");
                }
                ...
                if (ua.browser.ie > 8) {
                    ua.checkSameHtml(editor.getContent()
                                           .toLowerCase(), '<p><span style="color: rgb(196, 189, 151);" ></span><strong>xx</strong><em>em</em></p>', "span 有style但内容为空");
                } else {
                    ua.checkSameHtml(editor.getContent()
                                           .toLowerCase(), '<p><span style="color:#c4bd97" ></span><strong>xx</strong><em>em</em></p>', "span 有style但内容为空");
                }
                innerHTML = '<span style="color:#c4bd97">asdf<strong>xx</strong><em>em</em><em></em></span>';
                editor.setContent(innerHTML);
                if (ua.browser.ie > 8) {
                    ua.checkSameHtml(editor.getContent()
                                           .toLowerCase(), '<p><span style="color: rgb(196, 189, 151);" >asdf<strong>xx</strong><em>em</em></span></p>', "span 有style内容不空");
                } else {
                    ua.checkSameHtml(editor.getContent()
                                           .toLowerCase(), '<p><span style="color:#c4bd97" >asdf<strong>xx</strong><em>em</em></span></p>', "span 有style内容不空");
                }
...
test("getContent--不去除无用的空标签:autoClearEmptyNode==false", function () {
    ...
    editor.ready(function () {
        ...
        equal(editor.getContent()
                    .toLowerCase(), '<p><span><span></span><strong>xx</strong><em>em</em><em></em><strong></strong></span></p>', "span style空，套空的em和不空的em");
        innerHTML = '<span style="color:#c4bd97"></span><strong>xx</strong><em>em</em><em></em><strong></strong>';
        editor.setContent(innerHTML);
        ua.manualDeleteFillData(editor.body);
        if (ua.browser.ie > 8) {
            ua.checkSameHtml(editor.getContent()
                                   .toLowerCase(), '<p><span style="color: rgb(196, 189, 151);" ></span><strong>xx</strong><em>em</em><em></em><strong></strong></p>', "span 有style但内容为空");
        } else {
            ua.checkSameHtml(editor.getContent()
                                   .toLowerCase(), '<p><span style="color:#c4bd97" ></span><strong>xx</strong><em>em</em><em></em><strong></strong></p>', "span 有style但内容为空");
        }
        setTimeout(function () {
            UE.delEditor('ue');
            start();
