...
test('成功远程图片抓取', function () {
    ...
    setTimeout(function () {
        ...
        editor.ready(function () {
            ...
            editor.setContent('<p><img src="http://img0.bdstatic.com/static/common/widget/search_box_search/logo/logo_3b6de4c.png"><img src="https://www.baidu.com/img/flexible/logo/pc/result.png"></p>');
