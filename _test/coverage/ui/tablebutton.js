...
_$jscoverage['ui/tablebutton.js'].source = [
    ...
    "<span class=\"c\">///import ui/tablepicker.js</span>",
    ...
    "        TablePicker <span class=\"k\">=</span> baidu<span class=\"k\">.</span>editor<span class=\"k\">.</span>ui<span class=\"k\">.</span>TablePicker<span class=\"k\">,</span>",
    ...
    "        TableButton <span class=\"k\">=</span> baidu<span class=\"k\">.</span>editor<span class=\"k\">.</span>ui<span class=\"k\">.</span>TableButton <span class=\"k\">=</span> <span class=\"k\">function</span> <span class=\"k\">(</span>options<span class=\"k\">)</span><span class=\"k\">{</span>",
    "            <span class=\"k\">this</span><span class=\"k\">.</span>initOptions<span class=\"k\">(</span>options<span class=\"k\">);</span>",
    "            <span class=\"k\">this</span><span class=\"k\">.</span>initTableButton<span class=\"k\">();</span>",
    "        <span class=\"k\">}</span><span class=\"k\">;</span>",
    "    TableButton<span class=\"k\">.</span>prototype <span class=\"k\">=</span> <span class=\"k\">{</span>",
    "        initTableButton<span class=\"k\">:</span> <span class=\"k\">function</span> <span class=\"k\">()</span><span class=\"k\">{</span>",
    ...
    "                content<span class=\"k\">:</span> <span class=\"k\">new</span> TablePicker<span class=\"k\">(</span><span class=\"k\">{</span>",
    ...
    "                        me<span class=\"k\">.</span>_onPickTable<span class=\"k\">(</span>numCols<span class=\"k\">,</span> numRows<span class=\"k\">);</span>",
    "                    <span class=\"k\">}</span>",
    "                <span class=\"k\">}</span><span class=\"k\">),</span>",
    "                <span class=\"s\">'editor'</span><span class=\"k\">:</span>me<span class=\"k\">.</span>editor",
    "            <span class=\"k\">}</span><span class=\"k\">);</span>",
    "            <span class=\"k\">this</span><span class=\"k\">.</span>initSplitButton<span class=\"k\">();</span>",
    "        <span class=\"k\">}</span><span class=\"k\">,</span>",
    "        _onPickTable<span class=\"k\">:</span> <span class=\"k\">function</span> <span class=\"k\">(</span>numCols<span class=\"k\">,</span> numRows<span class=\"k\">)</span><span class=\"k\">{</span>",
    "            <span class=\"k\">if</span> <span class=\"k\">(</span><span class=\"k\">this</span><span class=\"k\">.</span>fireEvent<span class=\"k\">(</span><span class=\"s\">'picktable'</span><span class=\"k\">,</span> numCols<span class=\"k\">,</span> numRows<span class=\"k\">)</span> <span class=\"k\">!==</span> <span class=\"k\">false</span><span class=\"k\">)</span> <span class=\"k\">{</span>",
    "                <span class=\"k\">this</span><span class=\"k\">.</span>popup<span class=\"k\">.</span>hide<span class=\"k\">();</span>",
    "            <span class=\"k\">}</span>",
    "        <span class=\"k\">}</span>",
    "    <span class=\"k\">}</span><span class=\"k\">;</span>",
    "    utils<span class=\"k\">.</span>inherits<span class=\"k\">(</span>TableButton<span class=\"k\">,</span> SplitButton<span class=\"k\">);</span>",
    "",
    "<span class=\"k\">}</span><span class=\"k\">)();</span>"
];
        ...
        initTableButton: (function () {
            ...
            this.popup = new Popup({
                content: new TablePicker({
                    editor: me.editor, onpicktable: (function (t, numCols, numRows) {
