...
_$jscoverage['ui/multiMenu.js'].source = [
    "<span class=\"c\">///import core</span>",
    "<span class=\"c\">///import uicore</span>",
    " <span class=\"c\">///commands &#34920;&#24773;</span>",
    ...
    "        MultiMenuPop <span class=\"k\">=</span> baidu<span class=\"k\">.</span>editor<span class=\"k\">.</span>ui<span class=\"k\">.</span>MultiMenuPop <span class=\"k\">=</span> <span class=\"k\">function</span><span class=\"k\">(</span>options<span class=\"k\">)</span><span class=\"k\">{</span>",
    "            <span class=\"k\">this</span><span class=\"k\">.</span>initOptions<span class=\"k\">(</span>options<span class=\"k\">);</span>",
    "            <span class=\"k\">this</span><span class=\"k\">.</span>initMultiMenu<span class=\"k\">();</span>",
    "        <span class=\"k\">}</span><span class=\"k\">;</span>",
    "",
    "    MultiMenuPop<span class=\"k\">.</span>prototype <span class=\"k\">=</span> <span class=\"k\">{</span>",
    "        initMultiMenu<span class=\"k\">:</span> <span class=\"k\">function</span> <span class=\"k\">()</span><span class=\"k\">{</span>",
    ...
    "                iframe_rendered<span class=\"k\">:</span> <span class=\"k\">false</span><span class=\"k\">,</span>",
    "                onshow<span class=\"k\">:</span> <span class=\"k\">function</span> <span class=\"k\">()</span><span class=\"k\">{</span>",
    "                    <span class=\"k\">if</span> <span class=\"k\">(!</span><span class=\"k\">this</span><span class=\"k\">.</span>iframe_rendered<span class=\"k\">)</span> <span class=\"k\">{</span>",
    "                        <span class=\"k\">this</span><span class=\"k\">.</span>iframe_rendered <span class=\"k\">=</span> <span class=\"k\">true</span><span class=\"k\">;</span>",
    "                        <span class=\"k\">this</span><span class=\"k\">.</span>getDom<span class=\"k\">(</span><span class=\"s\">'content'</span><span class=\"k\">).</span>innerHTML <span class=\"k\">=</span> <span class=\"s\">'&lt;iframe id=\"'</span><span class=\"k\">+</span>me<span class=\"k\">.</span>id<span class=\"k\">+</span><span class=\"s\">'_iframe\" src=\"'</span><span class=\"k\">+</span> me<span class=\"k\">.</span>iframeUrl <span class=\"k\">+</span><span class=\"s\">'\" frameborder=\"0\"&gt;&lt;/iframe&gt;'</span><span class=\"k\">;</span>",
    "                        me<span class=\"k\">.</span>editor<span class=\"k\">.</span>container<span class=\"k\">.</span>style<span class=\"k\">.</span>zIndex <span class=\"k\">&amp;&amp;</span> <span class=\"k\">(</span><span class=\"k\">this</span><span class=\"k\">.</span>getDom<span class=\"k\">().</span>style<span class=\"k\">.</span>zIndex <span class=\"k\">=</span> me<span class=\"k\">.</span>editor<span class=\"k\">.</span>container<span class=\"k\">.</span>style<span class=\"k\">.</span>zIndex <span class=\"k\">*</span> <span class=\"s\">1</span> <span class=\"k\">+</span> <span class=\"s\">1</span><span class=\"k\">);</span>",
    "                    <span class=\"k\">}</span>",
    "                <span class=\"k\">}</span>",
    "               <span class=\"c\">// canSideUp:false,</span>",
    "               <span class=\"c\">// canSideLeft:false</span>",
    "            <span class=\"k\">}</span><span class=\"k\">);</span>",
    "            <span class=\"k\">this</span><span class=\"k\">.</span>onbuttonclick <span class=\"k\">=</span> <span class=\"k\">function</span><span class=\"k\">()</span><span class=\"k\">{</span>",
    ...
    "    <span class=\"k\">}</span><span class=\"k\">;</span>",
    "",
    "    utils<span class=\"k\">.</span>inherits<span class=\"k\">(</span>MultiMenuPop<span class=\"k\">,</span> SplitButton<span class=\"k\">);</span>",
    "<span class=\"k\">}</span><span class=\"k\">)();</span>"
];
