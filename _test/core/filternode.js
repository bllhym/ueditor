...
test('过滤标签部分属性', function () {
    ...
    equals(node.toHtml()
               .replace(/[ ]+>/g, '>'), '<div id="aa"><p style="color:#ccc"><td></td></p>sdfasdf</div>', '保留p的color属性');
    ...
    equals(node.toHtml()
               .replace(/[ ]+>/g, '>'), '<div id="aa"><p style="line-height:200%"><span>sdfs</span></p></div>', '过滤span全部属性，保留p部分属性，过滤strong标签');
    ...
    equals(node.toHtml()
               .replace(/[ ]+>/g, '>'), '<div id="aa"><p><u class="ad">sdfs<sub>sdfs</sub></u></p></div>', '过滤sub全部属性，保留u部分属性，过滤i标签');
});
test('标签替换过滤', function () {
    ...
    equals(node.toHtml()
               .replace(/[ ]+>/g, '>'), '<div id="aa"><p style="color:#ccc"><p>sdfssdfs</p></p>sdfasdf</div>', 'tr替换为p，过滤掉td');
    ...
    ua.checkSameHtml(node.toHtml()
                         .replace(/[ ]+>/g, '>'), '<div id="aa"><img src="http://img.baidu.com/hi/jx2/j_0020.gif" /><table>aldkfj<tbody><tr>adf &nbsp; &nbsp;</tr><tr><td>lkj</td></tr></tbody></table></div>', 'th按文本内容替换，保留img部分属性');
});
test('保留标签全部属性', function () {
    ...
    equals(node.toHtml()
               .replace(/[ ]+>/g, '>'), '<div id="aa"><ol><li>sdf</li><ul><li>a</li><li>b</li><li>c</li></ul><li>jkl</li></ol></div>', '保留ol、li全部属性，过滤ul全部属性');
});
test('过滤规则为空', function () {
    ...
    UE.filterNode(node, {});
    equals(node.toHtml()
               .replace(/[ ]+>/g, '>'), '<div id="aa"><p style="color:#ccc;border:1px solid #ccc;"><table><tbody><tr><td><h1>asd</h1></td></tr></tbody></table></p><div>sdfasdf</div></div>', '过滤规则为空');
});
...
test('只有white list--滤除属性', function () {
    ...
    ua.checkSameHtml(node.toHtml()
                         .replace(/[ ]+>/g, '>'), '<div id="aa"><table></table>hellotable<div id="div_id" class="div_class">hellodiv</div><span style="color:red;font-size:12px" >hellospan</span></div>', '滤除属性');
});
