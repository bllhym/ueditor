...
test('特殊标签处理', function () {
    ...
    equals(root.toHtml()
               .replace(/[ ]+>/g, '>'), '<script type="text/javascript" charset="utf-8" src="editor_api.js"></script>', 'script标签');
    root = UE.htmlparser('<table width="960"><tbody><tr><td width="939" valign="top"><br></td></tr></tbody></table><p><br></p>');
    equals(root.toHtml()
               .replace(/[ ]+>/g, '>'), '<table width="960"><tbody><tr><td width="939" valign="top"><br/></td></tr></tbody></table><p><br/></p>', 'br标签');
...
test('补全不完整li', function () {
    ...
    equals(root.toHtml()
               .replace(/[ ]+>/g, '>'), '<ol><li><em>sdf</em></li><ul><li>a</li><li>b</li><li>c</li></ul><li>jkl</li></ol>', '补全li');
...
test('开始标签与后面文本的空格过滤，其他不过滤inline节点之间的空格，过滤block节点之间的空格', function () {
    ...
    equals(root.toHtml()
               .replace(/[ ]+>/g, '>'), '<span> <span> hello </span></span> <span> he llo2<span> hello </span> </span>');
...
test('复杂标签嵌套', function () {
    ...
    equals(root.toHtml()
               .replace(/[ ]+>/g, '>'), '<span>hello1<p><img/>hello2<div>hello3<p>hello4</p></div></p></span>');
});
