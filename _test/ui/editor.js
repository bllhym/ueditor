...
test('拖拽', function () {
    ...
    ue.ready(function () {
        ...
        setTimeout(function () {
            ...
            setTimeout(function () {
                //取编辑器的边框
                var editorBorderWidth = parseInt($(this.document.getElementById(me.ui.id))
                    .css('border-left-width')) + parseInt($(this.document.getElementById(me.ui.id))
                    .css('border-right-width'));
                var editorBorderHeight = parseInt($(this.document.getElementById(me.ui.id))
                    .css('border-top-width')) + parseInt($(this.document.getElementById(me.ui.id))
                ...
                equal(parseInt($(this.document.getElementById(me.ui.id))
                    .css('width')), parseInt(editorWidth) + offset - 2 - editorBorderHeight + border, '宽');
