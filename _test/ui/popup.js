...
test('定位显示popup；mousedown时隐藏popup', function () {
    ...
    editor.ready(function () {
        ...
        equal($(popup.getDom())
            .css('width'), uiUtils.getClientRect(popup.getDom('content')).width + 'px', 'popup位置：width');
        ...
        equal($(popup.getDom())
            .css('height'), uiUtils.getClientRect(popup.getDom('content')).height + 'px', 'popup位置：height');
